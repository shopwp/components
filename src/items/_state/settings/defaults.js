const defaults = {
  collections: {
    ...
    dropzoneLoadMore: false,
    skipInitialRender: false,
    dropzoneCollectionTitle: false,
    dropzoneCollectionImage: false,
    dropzoneCollectionDescription: false,
    dropzoneCollectionProducts: false,
    infiniteScroll: false,
    infiniteScrollOffset: -200,
    ...
    linkTo: "wordpress",
    linkTarget: "_self",
    noResultsText: "No collections left to show",
    type: "collection",
    sorting: false,
  },
  products: {
